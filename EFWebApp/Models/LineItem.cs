...
namespace entity_framework_test2.Models
{
    public class LineItem
    {
        ...
        // Calculated Fields
        [SQLonAirLookup("Order", "CustomerName", "OrderId")]
        public string CustomerName { get; set; }

        [SQLonAirLookup("Product", "Name", "ProductId")]
        public string ProductName { get; set; }
        
        [SQLonAirLookup("Order", "CustomerTaxRateDisplay", "OrderId")]
        public string CustomerTaxRateDisplay { get; set; }

        [SQLonAirLookup("Product", "UnitPrice", "ProductId")]
        public decimal? UnitPrice { get; set; }

        [SQLonAirCalculation("Quantity * UnitPrice")]
        public decimal? SubTotal { get; set; }

        [SQLonAirLookup("Order", "CustomerTaxRate", "OrderId", Precision = 4)]
